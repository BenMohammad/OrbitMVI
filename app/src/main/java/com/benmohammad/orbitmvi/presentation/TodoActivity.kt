...
import com.benmohammad.orbitmvi.presentation.ui.LogoItem
import com.benmohammad.orbitmvi.presentation.ui.SpaceItemDecoration
import com.benmohammad.orbitmvi.presentation.ui.ToDoItem
import com.benmohammad.orbitmvi.presentation.ui.show
...
class TodoActivity: AppCompatActivity() {
    ...
    private fun render(state: TodoScreenState) {
        ...
        if(state.screenState == ScreenState.Ready) {
            ...
            state.todoSelectedId?.let {
                showTodoDialog(it)
            }

            state.userProfile?.let {
                showUserProfileDialog(it)
            }
        }
    }
    ...
    private fun showTodoDialog(todoId: Int) {
        if(todoDialog == null) {
            todoDialog = AlertDialog.Builder(this)
                ...
                .setMessage(getString(R.string.todo_dialog_msg))
